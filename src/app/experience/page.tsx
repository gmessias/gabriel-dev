const experiences = [
    {
        ...
        description: "Developer in the Ponto product team.",
    ...
    },
    {
        ...
        description: "Payroll product team, whose software processes payroll for over 1.5 million workers.",
    ...
    },
    {
        ...
        description: "The aim was to replace the software already used by the organization, as it had severe performance problems and some integrity problems. It was a success, we were able to replace it and it was also implemented in other government departments.",
    ...
    },
    {
        ...
        description: "Helpdesk and computer maintenance.",
        skills: ["Helpdesk"],
    },
    {
        title: "IT Support",
